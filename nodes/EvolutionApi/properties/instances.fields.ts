		...
		options: [
			{
				...
				values: [
					...
					{ displayName: 'Block Exact Duplicates', name: 'duplicateEnabled', type: 'boolean', default: true, description: 'Whether to block exact duplicate visible text for the same recipient' },
					{ displayName: 'Duplicate Window (Seconds)', name: 'duplicateWindowSeconds', type: 'number', default: 30, typeOptions: { minValue: 1, maxValue: 86400 }, description: 'Rolling duplicate comparison window' },
